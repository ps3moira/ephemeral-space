...
/// </summary>
/// <remarks>
/// We won't have such a big cvar list, so we can have it in one file. If it does reach over maybe 200 or so lines, try and seperate it into partial classes like upstream
/// </remarks>
[CVarDefs]
// ReSharper disable once InconsistentNaming | shh, be quiet
public sealed partial class ECCVars : CVars
{
    /// <summary>
